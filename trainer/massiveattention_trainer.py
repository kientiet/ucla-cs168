...
from models.our_model import massive_attention_16x4d
...
class MassiveAttentionTrainer(TrainerSkeleton):
	def __init__(self, trainloader, valloader,
			...
			super(MassiveAttentionTrainer, self).__init__(trainloader = trainloader, valloader = valloader)

			# Load pretrained model
			self.model = massive_attention_16x4d(num_classes)
